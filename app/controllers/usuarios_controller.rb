class UsuariosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @usuario.save
        ...
        format.html {redirect_to home_index_path, notice: "Usuário foi criado com sucesso"  }
      else
  ...
  def usuario_params
    params.require(:usuario).permit(:nome, :login, :password, :password_confirmation, :auth_token, :senha_reset_token, :senha_reset_sent_at)
  end
